...
export class SafetyEngine {
   ...
   */
  public classifyCommand(command: string): RiskLevel {
    const trimmed = command.trim();
   ...
   */
  public requiresApproval(risk: RiskLevel): boolean {
   ...
   */
  public requiresTypedConfirmation(risk: RiskLevel): boolean {
   ...
   */
  public explainRisk(command: string): string {
   ...
   */
  public scanForSecrets(input: string): boolean {
   ...
   */
  public analyzeCommand(command: string): SafetyReport {
