...
export const commandTemplatesList: CommandTemplate[] = [
  {
...
export class TemplateManager {
  ...
  public getTemplates(): CommandTemplate[] {
    return commandTemplatesList;
  }

  public getTemplate(id: string): CommandTemplate | undefined {
   ...
   */
  public async executeTemplate(id: string, args: Record<string, any>): Promise<{ success: boolean; output: string; reportPath?: string }> {
